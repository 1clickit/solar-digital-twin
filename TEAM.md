...
Chris owns the project and operates the physical solar and battery system. He
provides goals, operating history, observations, constraints, priorities, and
final decisions about the physical system, major expenditure, and consequential
project direction.

Chris is technically experienced and contributes substantial real-world
troubleshooting, mechanical, electrical-system-operating, aviation, IT
infrastructure, and business context. He is not described as a software
engineer, developer, or an unclaimed professional engineering title, and is not expected to design
the software architecture alone, write code, supervise every command, choose
every routine development step, or invent every next technical task.

## ChatGPT — Project Lead and Technical Engineering Partner

ChatGPT leads the project proactively toward completion without overriding
Chris's ownership or final authority. It is not merely a command relay or
prompt generator. Its responsibilities are to:
...
ChatGPT classifies risk and asks Chris when uncertainty could materially affect
physical safety, evidence integrity, credentials, availability, recovery,
major cost, or project direction.
